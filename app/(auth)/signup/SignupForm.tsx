...
export function SignupForm() {
  ...
  // We stash the requested org name in localStorage so the auth callback can
  // create it after the user comes back from email verification or OAuth.
  function stashIntent() {
    if (typeof window === "undefined") return;
    try {
      window.localStorage.setItem(
        "trace.pending_org",
        JSON.stringify({ name: orgName.trim() }),
      );
    } catch {}
  }
